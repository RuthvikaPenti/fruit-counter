    ...
    return (
        <div className = "fruits-counter-container">
            ...
            <div className = "fruits-counter">
                ...
                <h1 className= "count-text"> Bob ate 
                ...
                <div className="counters-control-container">
                    <div className="counter-control">
                        ...
                        alt="mango" className="fruit-image" /> 

                    <div className="button-container">
                        <button type="button" className="button" onClick={this.onClickEatMango}>
                            Eat Mango
                        </button>      
                    </div>
                </div>
            ...
            <div className="counter-control">
                ...
                alt="banana" className= "fruit-image" />
